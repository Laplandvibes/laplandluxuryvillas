...
const BUILT_IN_SITE_LABELS: Record<string, Record<SiteLabelsKey, string>> = {
  ...
  fr: { hotelDeals:'Offres hôtelières sélectionnées',staysCabins:'Hébergements & Chalets',whereToStay:'Igloos de verre, chalets, lodges',familyFriendly:'Resorts famille + visites au Père Noël',localFood:'Cuisine sami + cueillette',fineDining:'Gastronomie',barsPubs:'Bars & Pubs',activities:'Activités arctiques sélectionnées',huskySafaris:'Safaris en traîneau à chiens, opérateurs comparés',skiResorts:'Stations de ski comparées',snowmobileTours:'Safaris en motoneige & location',spaWellness:'Saunas, spas, bien-être & aurores',nightlife:'Vie nocturne',natureParks:'Nature & Parcs',travelGuide:'Guide de voyage',christmas:'Noël en Laponie, Village du Père Noël, aurores',giftsSouvenirs:'Cadeaux & Souvenirs',travelBlog:'Blog voyage',dealsOffers:'Offres',transport:'Transport',carRental:'Location de voiture',workInLapland:'Travailler en Laponie' },
