...
const TABLES: Partial<Record<FactLocale, Record<string, string>>> = {
  'fi': {
    ...
    "Road distance Ivalo airport to Inari village, roughly 40 minutes by car.": "Ajomatka Ivalon lentoasemalta Inarin kylään, noin 40 minuuttia autolla.",
    "Road distance Ivalo airport to Saariselkä village, about half an hour by car.": "Ajomatka Ivalon lentoasemalta Saariselän kylään, noin puoli tuntia autolla.",
    "Road distance Kittilä airport to Levi village, about 20 minutes by car.": "Ajomatka Kittilän lentoasemalta Levin kylään, noin 20 minuuttia autolla.",
    "Road distance Kittilä airport to Äkäslompolo, about 45 minutes by car.": "Ajomatka Kittilän lentoasemalta Äkäslompoloon, noin 45 minuuttia autolla.",
  ...
  'zh-CN': {
    ...
    "Finland's third-largest national park; the two Ylläs villages sit on opposite sides of it.": "芬兰第三大国家公园；于拉斯（Ylläs）的两个村庄分处公园两侧。",
    ...
    "Pallas-Yllästunturi National Park": "帕拉斯-于拉斯通图里国家公园",
