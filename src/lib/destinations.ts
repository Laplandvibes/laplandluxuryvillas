...
export const DESTINATIONS: Destination[] = [
  ...
  },
  {
    ...
    copy: [
      'Ylläs has 62 slopes, more than any other resort in Finland, and the longest downhill runs in the country at over three kilometres from the treeless 719-metre top. It still feels a fraction of Levi\'s size, because the village is dispersed across two settlements (Äkäslompolo and Ylläsjärvi) separated by 15 km of fell, with Pallas-Yllästunturi National Park between them.',
    ...
    highlights: [
      ...
      'Inside a national park, so no resort light on the fell side',
