...
const overlay: { villas: Record<string, VillaOv>; destinations: Record<string, DestOv>; experiences: Record<string, ExpOv> } = {
  villas: {
    ...
    'arctic-treehouse-suite': {
      tagline: 'Suíte em balanço projetada por Studio Puisto, com fachada de vidro inteira voltada para as auroras.',
      copy: [
      ...
      signature: [
        ...
        'Restaurante Rakas na propriedade',
    ...
    'star-arctic-suite': {
      tagline: 'Uma suíte com paredes de vidro no cume do fell Kaunispää, acima da linha das árvores e das luzes da vila.',
      copy: [
      ...
      signature: [
        'Vidro de 270° no cume, acima da linha das árvores',
    ...
    'lapland-hotels-saaga-apartment': {
      tagline: 'Um apartamento independente ao pé das encostas sul do Ylläs, com o spa do hotel logo atrás.',
      copy: [
        'O Lapland Hotels Saaga fica na vila de Ylläsjärvi, logo abaixo das encostas sul da estação de Ylläs. Além dos quartos, aluga apartamentos para uma a oito pessoas, dentro da área do hotel ou a cerca de 300 metros do prédio principal, de modo que uma família ou um grupo pequeno tenha seu próprio espaço sem sair do resort.',
        'Por trás dos apartamentos está o hotel inteiro: um spa com área de piscina, hidromassagens e saunas a vapor, sala de ginástica e tratamentos, e uma sauna privativa para até quinze pessoas com sua própria área de descanso. Há três restaurantes na área, incluindo o bufê Biegga, e o café da manhã é feito com ingredientes do norte.',
      ],
      signature: [
        'Vila de Ylläsjärvi, abaixo das encostas sul do Ylläs',
        'Apartamentos para 1–8 hóspedes',
        'Na área do hotel ou a cerca de 300 m do prédio principal',
        'Spa: área de piscina, hidromassagens, saunas a vapor, ginástica',
        'Sauna privativa para até 15 com área de descanso própria',
        'Três restaurantes na área, incluindo o bufê Biegga',
      ],
    },
  ...
  destinations: {
    ...
    'rovaniemi': {
      ...
      arrival: 'Rovaniemi (RVN), 10 km, 10 a 15 min do centro da cidade',
      auroraNote: 'Nosso destino mais ao sul e o único com as luzes de uma cidade no horizonte, de modo que a aurora aqui é ao mesmo tempo menos frequente e mais difícil de ver. Melhor combinada com pelo menos uma noite em uma vila de fell mais ao norte.',
    },
    'levi': {
      ...
      arrival: 'Kittilä (KTT), 15 km, cerca de 20 min por transfer privativo',
      auroraNote: 'Um panorama voltado para o sul, o que é raro na Lapônia: a vila de fell iluminada vira o primeiro plano da fotografia. O preço é essa mesma luz, então a vista mais escura fica a uma curta viagem de carro.',
    },
    'yllas': {
      ...
      highlights: [
        ...
        'Cerca de 300 km de trilhas de cross-country preparadas, mais de 30 km iluminadas',
      ],
      arrival: 'Kittilä (KTT), 40 km, cerca de 45 min por transfer privativo',
      auroraNote: 'Os chalés ficam encostados no parque nacional em vez de no meio de um resort, então você sai pela porta direto para o escuro em vez de dirigir para procurá-lo.',
    },
  },
  experiences: {
