...
const overlay: { villas: Record<string, VillaOv>; destinations: Record<string, DestOv>; experiences: Record<string, ExpOv> } = {
  ...
  destinations: {
    'saariselka': {
      ...
      auroraNote: '内陸の北方林で、どの方角にも数十キロにわたって集落の灯りがありません。フィエルが高く開けた地平線をつくるため、アークが北の低い位置にとどまる夜ほど効いてきます。',
    },
    'inari': {
      position: '当社の目的地でもっとも北にあり、オーロラはおよそ4夜に3夜観測されます。サーミの中心地、Inari湖、暗い空。',
      copy: [
        'Inariはフィンランド最北の自治体であり、フィンランド系サーミの文化的な首府です。村は、フィンランド第三の大きさで約3,000の島々を擁するInari湖のほとりにあります。北極圏から200 km以上北に位置し、地平線に街の灯りはありません。',
    ...
    'rovaniemi': {
      ...
      auroraNote: '当社の目的地でもっとも南にあり、地平線に街の灯りがある唯一の場所です。そのぶんオーロラは出現も少なく、出ても見えにくくなります。より北のフィエルの村で最低一泊と組み合わせるのが最良です。',
    },
    'levi': {
      position: 'フィンランド屈指のスキーリゾート。南斜面の高級シャレー、Leviのゴンドラからスキーイン/スキーアウト。',
      copy: [
        'LeviはLaplandでもっとも開発の進んだフィエルリゾートで、44本のコースと26基のリフト（うち2基はゴンドラ）を備えた、完結した冬季スポーツの村です。デザイナーシャレーのレンタル市場はこの10年で本格化しました。ゴンドラは村の中心から標高531 mの山頂まで運行し、南斜面にプライベートシャレーが並びます。2026-2027シーズンにはその南斜面に新しいチェアリフトが開業します。',
      ...
      auroraNote: '南向きのパノラマはLaplandでは珍しく、灯りのともるフィエルの村がそのまま写真の前景になります。その代償が村自身の灯りで、もっとも暗い眺めは車で少し走った先にあります。',
    },
    'yllas': {
