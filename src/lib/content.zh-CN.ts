...
const overlay: { villas: Record<string, VillaOv>; destinations: Record<string, DestOv>; experiences: Record<string, ExpOv> } = {
  ...
  destinations: {
    ...
    'inari': {
      ...
      copy: [
        '伊纳里（Inari）是芬兰面积最大的市镇，也是芬兰萨米人（Sámi）的文化之都。村庄坐落于芬兰第三大湖伊纳里湖（Lake Inari）畔，湖中约有 3,000 座岛屿；此地位于北极圈以北 200 多公里，地平线上没有任何城市灯光。',
        '对奢华旅行而言，这意味着两件事。其一：在这个纬度，芬兰气象研究所每四夜约有三夜观测到极光，且极光悬于头顶而非低垂北方。其二：湖畔原木宅邸属于拉普兰最静谧的住宿，没有过境车流，可见地平线上也没有邻近村落。',
      ],
      highlights: [
    ...
    'levi': {
      ...
      copy: [
        ...
        '从列维（Levi）观赏极光朝南且极具戏剧张力，这在拉普兰实属罕见，而灯火通明的村庄天际线也成了照片的一部分。最好搭配在更北处（伊纳里 Inari 或萨利色尔卡 Saariselkä）住上一两晚，体验真正的荒野极光，再回到这里滑雪。',
      ],
      highlights: [
    ...
    'yllas': {
      position: '列维（Levi）的静谧之选。帕拉斯-于拉斯通图里（Pallas-Yllästunturi）国家公园，人群更少，森林更深。',
      copy: [
        '于拉斯（Ylläs）拥有 62 条雪道，多于芬兰任何一处滑雪区域，也拥有全国最长的滑降：从海拔 719 米的无林山顶到谷底超过三公里。它体感却只有列维的一小部分，因为村庄分散于两处聚落（Äkäslompolo 与 Ylläsjärvi），由 15 公里的山丘和帕拉斯-于拉斯通图里国家公园（Pallas-Yllästunturi National Park）相隔。',
        '对奢华旅行而言，其魅力在于空间。此处由建筑师打造的小屋独立伫立于山坡之上，国家公园的步道从物业出发，人们真正为之买单的，正是这份静谧。越野滑雪道网络约 300 公里，其中 30 多公里配有照明。',
      ],
      highlights: [
        '帕拉斯-于拉斯通图里国家公园（Pallas-Yllästunturi National Park）、芬兰第三大',
        '于拉斯（Ylläs）山丘两侧各有一座滑雪村庄',
        '光污染低于任何其他滑雪胜地',
  ...
  experiences: {
    ...
    'private-jet-arrival': {
      ...
      copy: [
        '经由我们在赫尔辛基、日内瓦与多哈的公务机伙伴统筹安排。直飞伊瓦洛（Ivalo，最靠近萨利色尔卡 Saariselkä / 伊纳里 Inari 的别墅）、基蒂莱（Kittilä，最靠近列维 Levi / 于拉斯 Ylläs 的别墅），或罗瓦涅米（Rovaniemi，最适合 Arctic TreeHouse）。',
