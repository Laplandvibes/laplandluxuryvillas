...
const COPY: Record<Lang, { eyebrow: string; h3: string; cta: string; sqm: string; bedrooms: string; sleeps: string; from: string; perWeek: string; sourceNote: (d: string) => string }> = {
  fi: { eyebrow: 'Mainos · käsin valitut', h3: 'Kolme tilavaa mökkiä Lapista', cta: 'Katso mökki', sqm: 'm²', bedrooms: 'makuuhuonetta', sleeps: 'nukkuu', from: 'alkaen', perWeek: '/ viikko', sourceNote: (d) => `Tiedot Lomarenkaan omasta tuotesyötteestä, päivitetty ${d}. Hinnan näet valitsemillesi päiville Lomarenkaalla.` },
  en: { eyebrow: 'Ad · hand-picked', h3: 'Three large cabins in Lapland', cta: 'See the cabin', sqm: 'm²', bedrooms: 'bedrooms', sleeps: 'sleeps', from: 'from', perWeek: '/ week', sourceNote: (d) => `Details from Lomarengas' own product feed, updated ${d}. See the price for your dates on Lomarengas.` },
  de: { eyebrow: 'Anzeige · handverlesen', h3: 'Drei große Hütten in Lappland', cta: 'Hütte ansehen', sqm: 'm²', bedrooms: 'Schlafzimmer', sleeps: 'Schlafplätze', from: 'ab', perWeek: '/ Woche', sourceNote: (d) => `Angaben aus dem Produktfeed von Lomarengas, aktualisiert am ${d}. Den Preis für Ihre Daten sehen Sie bei Lomarengas.` },
  ja: { eyebrow: '広告・厳選', h3: 'ラップランドの広いコテージ3棟', cta: 'コテージを見る', sqm: 'm²', bedrooms: '寝室', sleeps: '定員', from: '', perWeek: '／週', sourceNote: (d) => `情報はLomarengasの商品フィードより。更新日 ${d}。ご希望の日程の料金はLomarengasでご確認ください。` },
  es: { eyebrow: 'Anuncio · selección propia', h3: 'Tres cabañas amplias en Laponia', cta: 'Ver la cabaña', sqm: 'm²', bedrooms: 'dormitorios', sleeps: 'duerme', from: 'desde', perWeek: '/ semana', sourceNote: (d) => `Datos del propio feed de productos de Lomarengas, actualizado el ${d}. Vea el precio para sus fechas en Lomarengas.` },
  'pt-BR': { eyebrow: 'Anúncio · seleção nossa', h3: 'Três cabanas amplas na Lapônia', cta: 'Ver a cabana', sqm: 'm²', bedrooms: 'quartos', sleeps: 'acomoda', from: 'a partir de', perWeek: '/ semana', sourceNote: (d) => `Dados do próprio feed de produtos da Lomarengas, atualizado em ${d}. Veja o preço para as suas datas na Lomarengas.` },
  'zh-CN': { eyebrow: '广告 · 精选', h3: '拉普兰三座宽敞小屋', cta: '查看小屋', sqm: '平方米', bedrooms: '间卧室', sleeps: '可住', from: '起价', perWeek: '／周', sourceNote: (d) => `资料来自 Lomarengas 自有商品数据，更新于 ${d}。所选日期的价格请在 Lomarengas 查看。` },
  ko: { eyebrow: '광고 · 직접 선정', h3: '라플란드의 넓은 오두막 3채', cta: '오두막 보기', sqm: 'm²', bedrooms: '침실', sleeps: '숙박', from: '부터', perWeek: '/ 주', sourceNote: (d) => `정보는 Lomarengas 자체 상품 피드 기준, ${d} 갱신. 원하는 날짜의 가격은 Lomarengas에서 확인하세요.` },
  fr: { eyebrow: 'Annonce · sélection maison', h3: 'Trois grands chalets en Laponie', cta: 'Voir le chalet', sqm: 'm²', bedrooms: 'chambres', sleeps: 'couche', from: 'à partir de', perWeek: '/ semaine', sourceNote: (d) => `Informations issues du flux produits de Lomarengas, mis à jour le ${d}. Voyez le prix pour vos dates sur Lomarengas.` },
  it: { eyebrow: 'Annuncio · selezione nostra', h3: 'Tre baite ampie in Lapponia', cta: 'Vedi la baita', sqm: 'm²', bedrooms: 'camere', sleeps: 'posti letto', from: 'da', perWeek: '/ settimana', sourceNote: (d) => `Dati dal feed prodotti di Lomarengas, aggiornato il ${d}. Il prezzo per le Sue date è su Lomarengas.` },
  nl: { eyebrow: 'Advertentie · handmatig gekozen', h3: 'Drie ruime huisjes in Lapland', cta: 'Bekijk het huisje', sqm: 'm²', bedrooms: 'slaapkamers', sleeps: 'slaapt', from: 'vanaf', perWeek: '/ week', sourceNote: (d) => `Gegevens uit de eigen productfeed van Lomarengas, bijgewerkt op ${d}. De prijs voor uw data ziet u bij Lomarengas.` },
  sv: { eyebrow: 'Annons · handplockade', h3: 'Tre rymliga stugor i Lappland', cta: 'Se stugan', sqm: 'm²', bedrooms: 'sovrum', sleeps: 'sover', from: 'från', perWeek: '/ vecka', sourceNote: (d) => `Uppgifter från Lomarengas egen produktfeed, uppdaterad ${d}. Priset för dina datum ser du hos Lomarengas.` },
}
