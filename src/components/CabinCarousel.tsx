...
const COPY: Record<Lang, { eyebrow: string; h3: string; cta: string; sqm: string; bedrooms: string; sleeps: string; from: string; perWeek: string; sourceNote: (d: string) => string }> = {
  ...
  de: { eyebrow: 'Anzeige · handverlesen', h3: 'Drei große Hütten in Lappland', cta: 'Hütte ansehen', sqm: 'm²', bedrooms: 'Schlafzimmer', sleeps: 'schläft', from: 'ab', perWeek: '/ Woche', sourceNote: (d) => `Angaben und Preise aus dem Produktfeed von Lomarengas, aktualisiert am ${d}.` },
