...
export const VILLA_FAQ_BY_LANG: Record<Lang, VillaFaq[]> = {
  ...
  ja: [
    ...
    },
    {
      ...
      a: '収容人数はコレクションによって異なります。グラスイグルーやデザインスイートは通常2名向けで、湖畔のログハウスや大きめのシャレーは家族や少人数のグループに対応します。各ヴィラのページに宿泊人数と寝室の構成を記載しており、ご一行の人数をお知らせいただければ、合う宿をご提案します。',
    },
    {
  ...
  ko: [
    ...
    },
    {
      ...
      a: '라플란드의 오로라 시즌은 밤이 충분히 어두워지는 대략 8월 말부터 4월 초까지입니다. 활동이 가장 활발하고 눈이 가장 확실한 시기는 12월부터 3월까지입니다. 오로라 대신 백야와 밝고 온화한 밤을 원하신다면 6월부터 7월 사이에 방문하세요. 적절한 시기는 오로라, 설상 액티비티, 극지의 여름 중 무엇을 위해 여행하시는지에 따라 달라집니다.',
    },
    {
      q: '럭셔리 빌라는 프라이빗 가이드와 차량 이동을 제공하나요?',
      a: '많은 빌라가 제공합니다. 여러 숙소가 자체 운영사를 통해 로바니에미, 키틸래, 이발로 공항에서의 프라이빗 차량 이동과 오로라 헌팅, 허스키·순록 체험, 스노모빌 프라이빗 가이드를 마련합니다. 저희가 이를 대신 준비하거나 확정하지는 않습니다. 숙소에 직접 문의하시거나, 저희에게 물어보시면 어디가 운영하는지 알려 드립니다.',
    },
    {
