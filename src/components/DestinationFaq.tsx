...
const L: Record<Lang, T> = {
    ...
    aWhenAurora: 'Revontulia varten pimeä kausi, karkeasti syyskuusta maaliskuuhun. Keskitalvella yö on pisin ja lomakausien ulkopuoliset viikot rauhallisimpia.',
  ...
  en: {
    ...
    aWhenAurora: 'For the aurora, the dark season, roughly September to March. Midwinter has the longest nights, and the weeks outside school holidays are the quietest.',
  ...
  de: {
    ...
    aWhenAurora: 'Für das Polarlicht die dunkle Jahreszeit, etwa September bis März. Im Hochwinter sind die Nächte am längsten, und außerhalb der Ferienwochen ist es am ruhigsten.',
  ...
  ja: {
    ...
    qWhen: 'いつ訪れるのがよいですか？',
    aWhenAurora: 'オーロラ目的なら暗い季節、おおよそ9月から3月です。真冬は夜がもっとも長く、学校休暇を外した週がもっとも静かです。',
  ...
  es: {
    ...
    aWhenAurora: 'Para la aurora, la temporada oscura, aproximadamente de septiembre a marzo. En pleno invierno las noches son más largas, y las semanas fuera de vacaciones escolares son las más tranquilas.',
  ...
  'pt-BR': {
    ...
    aWhenAurora: 'Para a aurora, a estação escura, aproximadamente de setembro a março. No auge do inverno as noites são mais longas, e as semanas fora das férias escolares são as mais tranquilas.',
  ...
  'zh-CN': {
    ...
    qWhen: '什么时候来最合适？',
    aWhenAurora: '看极光要选黑夜季节，大致从九月到三月。隆冬夜最长，避开学校假期的周次最为清静。',
  ...
  ko: {
    ...
    qWhen: '언제 오는 것이 좋습니까?',
    aWhenAurora: '오로라를 보려면 어두운 계절, 대략 9월부터 3월까지입니다. 한겨울에 밤이 가장 길고, 방학을 피한 주가 가장 한산합니다.',
  ...
  fr: {
    ...
    aWhenAurora: 'Pour l’aurore, la saison sombre, en gros de septembre à mars. Au cœur de l’hiver les nuits sont les plus longues, et les semaines hors vacances scolaires les plus calmes.',
  ...
  it: {
    ...
    aWhenAurora: 'Per l’aurora la stagione buia, all’incirca da settembre a marzo. In pieno inverno le notti sono più lunghe e le settimane fuori dalle vacanze scolastiche sono le più tranquille.',
  ...
  nl: {
    ...
    aWhenAurora: 'Voor het noorderlicht het donkere seizoen, grofweg september tot maart. Midden in de winter zijn de nachten het langst, en de weken buiten de schoolvakanties het rustigst.',
  ...
  sv: {
    ...
    aWhenAurora: 'För norrskenet den mörka årstiden, ungefär september till mars. Mitt i vintern är nätterna längst, och veckorna utanför skolloven lugnast.',
