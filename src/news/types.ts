/**
 * Uutisosio — tietomalli (kopioitu laplandflights.fi:n mallista laplandnaturen kautta 24.9.2026).
 *
...
export type NewsBlock =
  ...
  /** Sivuston oma komponentti (tässä: mitta-asteikko). Kieliriippumaton data meta.jsonin
   *  `embeds[id]`:ssä, kielikohtaiset tekstit tässä lohkossa.
   *  🔴 `items` on lisäys flightsin malliin (laplandnature 24.9.2026): kuvan selitteet
