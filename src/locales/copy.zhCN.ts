...
const zhCN: SiteCopy = {
  ...
  hero: {
    home: {
      eyebrow: '私人精选',
      title: '拉普兰四个目的地，七栋别墅与套房。',
      lede: '一份精挑细选的私人奢华别墅小型珍藏，遍布拉普兰各地。价格见各家自己的预订页面，或发送一封私人咨询。',
      primary: '浏览精选',
      secondary: '私人咨询',
    },
    villas: {
      eyebrow: '精选系列',
      title: '七栋别墅。四个目的地。一次私人咨询。',
    ...
    about: {
      eyebrow: '关于我们',
      title: '一份刻意保持简短的名单。',
      lede: '芬兰拉普兰精挑细选的七栋别墅与套房。匿名咨询、直达各家自己的预订页面，中间不经任何平台。',
    },
  },
  home: {
    philosophy: {
      ...
      h2: '与预订平台恰恰相反。',
      items: [
        { title: '一份精选名单,而非目录。', body: '七栋别墅与套房，坐落在真正值得专程前往的目的地。我们婉拒物业的次数多于收录,本页每一项,都是讲究的旅人可以毫不犹豫预订的。' },
        { title: '匿名咨询。', body: '只有一个私人收件箱,没有公开档案,也不与第三方共享日历。发送日期、人数与偏好,一个工作日内即可收到精选名单。' },
        { title: '尽可能提供直接价格。', body: '公开房源直接链接至各家自己的预订页面，价格就写在那里。若未公开价格，则由该住宿自行报价。我们不定价，也不接受预订。' },
      ],
    },
    signature: {
      eyebrow: '臻选别墅',
  ...
  footerNote:
    '一份在芬兰拉普兰精心甄选的私人精选,最近一次复核于 2026 年 5 月。部分预订会带来联盟佣金,但绝不影响推荐哪些别墅。房子无法花钱进入这份精选。',
  footerPillars: [
