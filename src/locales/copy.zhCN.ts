...
const zhCN: SiteCopy = {
  ...
  hero: {
    ...
    about: {
      eyebrow: '关于我们',
      title: '一份刻意保持简短的名单。',
      lede: '芬兰拉普兰精挑细选的八栋别墅与套房。匿名咨询、直达各家自己的预订页面，中间不经任何平台。',
    },
  },
  home: {
    philosophy: {
      ...
      h2: '与预订平台恰恰相反。',
      items: [
        { title: '一份精选名单,而非目录。', body: '八栋别墅与套房，坐落在真正值得专程前往的目的地。我们婉拒物业的次数多于收录,本页每一项,都是讲究的旅人可以毫不犹豫预订的。' },
