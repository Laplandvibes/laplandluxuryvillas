...
const zhCN: SiteCopy = {
  ...
  midnightSunPage: {
    ...
    reasons: [
      ...
      { title: 'reserve 别墅开放了。', body: '湖畔的私人原木庄园与建筑师木屋会释出当年余下的日程。这段时节窗口,是一年里私人主厨与直升机包机按淡旺交替价报价的唯一时段。' },
    ...
    planning: {
      h2: '关于规划午夜阳光之旅的几句提醒。',
      p1: '这段时节很短,而别墅皆为个人所有,因此日程是见缝插针地填满,而非均匀分布。礼宾每年夏天都会在 reserve 庄园中预留少量配额。',
