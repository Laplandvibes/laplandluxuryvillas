...
const zhCN: SiteCopy = {
  ...
  hero: {
    home: {
      eyebrow: '{n}栋别墅 · {m}个目的地',
      title: '在拉普兰选别墅，不靠猜。',
      lede: "{n}座玻璃屋顶别墅与设计套房，分布在拉普兰的{m}个目的地，每一处都有独立的预订页面，Google 评分一并列出。把您的日期发来，一天之内您会收到一份筛选过的名单。",
      primary: '查看别墅',
      secondary: '请求推荐',
    },
    villas: {
      eyebrow: '别墅列表',
      title: '{n}栋别墅，{m}个目的地。一条消息就够。',
    ...
    about: {
      eyebrow: '关于我们',
      title: '一份刻意保持简短的名单。',
      lede: '在芬兰拉普兰精选的{n}栋别墅和套房。链接直达各房源自己的预订页面，中间没有平台，在你主动联系之前，你的信息不会流向任何地方。',
    },
  },
  home: {
    packages: {
    ...
    philosophy: {
      ...
      h2: '我们核实并推荐，您直接向房源预订。',
      items: [
        { title: '只收录核实过的房源。', body: '这份清单只有{n}栋别墅和套房，不会更多。每一处都依据房源自行公布的信息和近期住客评价核实，清单是活的：水准不再达标的房源会被移除。' },
