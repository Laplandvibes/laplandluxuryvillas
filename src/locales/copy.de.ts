...
const de: SiteCopy = {
  ...
  villasPage: {
    ...
    leadP2: 'Die Bewertungen auf dieser Seite stammen von Google und gelten dem ganzen Haus, nie dem einzelnen Zimmer, und jede Karte sagt das dazu. Die Auswahl ist bewusst kurz: fünf Ziele und vier Bauarten, vom Glasdach bis zum Alpenchalet, und dann hört sie auf, statt die Liste zu füllen.',
  ...
  suitesPage: {
    intro: {
      p1Pre: '„Suite“ in Lappland umfasst zwei deutlich verschiedene architektonische Ansätze, beide sollte man kennen. Der erste ist die ',
      designerSuite: 'Designer-Suite',
      p1Mid: ', bei der ein finnisches Architekturbüro wie Studio Puisto ein einzelnes Schlafzimmer um eine einzelne Aussicht herum gebaut hat. Der zweite ist die ',
      glassRoof: 'Glasdach-Hütte',
      p1Post: ', bei der die Decke das auffälligste Detail ist. Beide sind unten aufgeführt.',
    },
    inquiryTitle: 'Eine Zwei-Suiten-Buchung oder eine private Etage?',
    inquiryBody: 'Mehrere dieser Anwesen geben in der Zwischensaison eine Mehrsuiten-Etage zur ausschließlichen Nutzung frei. Teilen Sie uns Termine und Gästezahl mit.',
  },
  destinationsPage: {
  ...
  midnightSunPage: {
    ...
    summerCollection: {
      ...
      lede: 'Dieselben architektonischen Kategorien wie die Winterkollektion, Glasdach-Hütten, Seeufer-Blockhaus-Güter, Alpenchalets, Waldvillen, gezeigt im Mitternachtssonnenlicht des späten Juni, um die zweite Hälfte der Geschichte zu zeigen.',
      cards: [
  ...
  inquiryPage: {
    ...
    fields: {
      ...
      budget: 'Budget pro Nacht (Richtwert)',
  ...
  villaDetailPage: {
    ...
    sleeps: 'Schlafplätze',
    fromPerNight: 'Ab / Nacht',
    nightlyHint: 'Übernachtungspreis als Richtwert für die Nebensaison. Der tatsächliche Preis hängt von Terminen, Aufenthaltsdauer und Einschlüssen ab.',
    rate: 'Preis',
    onRequest: 'Auf Anfrage',
