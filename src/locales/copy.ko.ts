...
const ko: SiteCopy = {
  ...
  midnightSunPage: {
    ...
    reasons: [
      ...
      { title: 'reserve 빌라가 열립니다.', body: '호숫가 프라이빗 통나무 저택, 건축가의 샬레가 그해 남은 일정을 엽니다. 이 기간은 프라이빗 셰프와 헬리콥터 전세기가 비수기 사이 요금을 제시하는 한 해의 유일한 시기입니다.' },
    ...
    planning: {
      ...
      p1: '이 기간은 짧고 빌라는 개인 소유이기에, 캘린더는 고르게가 아니라 기회가 닿는 대로 채워집니다. 컨시어지는 매년 여름 reserve 저택에 소량의 배정분을 확보해 둡니다.',
...
Object.assign(ko.midnightSunPage, {
  ...
  reasons: [
    ...
    { title: '리저브 빌라가 개방됩니다.', body: '프라이빗 호숫가 로그 저택과 건축가 샬레가 나머지 캘린더를 풉니다. 이 기간은 프라이빗 셰프와 헬기 차터가 비수기 요금을 견적하는 1년 중 유일한 시기입니다.' },
  ...
  planning: { h2: '백야 여행 계획에 대한 짧은 메모.', p1: '이 기간은 짧고 빌라는 개별 소유이므로, 캘린더는 균등하기보다 기회적으로 채워집니다. 컨시어지는 매년 여름 리저브 저택에 소량의 할당을 보유합니다.', p2: '특정 6월 문의의 적기는 그 해 1~3월입니다. 그 이후의 문의도 보낼 가치가 있습니다, 출시가 발생하니까요, 그러나 고급 인벤토리는 종종 더 일찍 나갑니다.', quoting: '현재 2026 + 2027 여름 견적 중' },
