...
const ko: SiteCopy = {
  ...
  hero: {
    home: {
      ...
      lede: '모든 숙소는 숙소가 직접 공개한 정보와 최근 투숙객 후기로 확인했습니다. 숙소에 직접 예약하거나, 날짜와 인원을 알려주시면 하루 안에 가장 알맞은 곳을 제안해 드립니다.',
      primary: '빌라 보기',
      secondary: '추천 요청',
    },
    villas: {
  ...
  home: {
    philosophy: {
      ...
      items: [
        ...
        { title: '가격은 저희가 아니라 숙소에 있습니다.', body: '공개 예약 페이지가 있는 빌라는 링크가 바로 그곳으로 연결되어 결정 전에 요금이 보입니다. 공개된 요금이 없으면 숙소가 직접 견적을 드립니다. 저희는 가격을 정하지 않고 예약도 받지 않습니다.' },
      ],
    },
    signature: {
      eyebrow: '시그니처 빌라',
  ...
  suitesPage: {
    intro: {
      ...
      p1Mid: '입니다. 핀란드의 건축 스튜디오(Studio Puisto 등)가 단 하나의 풍경을 중심으로 원베드룸을 지은 곳이죠. 둘째는 ',
      glassRoof: '글래스 루프 캐빈',
  ...
  midnightSunPage: {
    ...
    planning: {
      ...
      quoting: '현재 2026년 및 2027년 여름 문의를 받고 있습니다',
    },
  ...
  contactPage: {
    ...
    cards: {
      private: {
        eyebrow: '프라이빗 문의',
        body: '비공개 여행 계획, 빌라 후보 선정, 직접 요금 문의. 영업일 기준 1일 이내에 답변드립니다.',
      },
      press: {
        eyebrow: '언론 및 제휴',
