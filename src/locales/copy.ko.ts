...
const ko: SiteCopy = {
  ...
  hero: {
    home: {
      eyebrow: '프라이빗 컬렉션',
      title: '라플란드 네 곳의 목적지에 빌라와 스위트 일곱 채.',
      lede: '라플란드 곳곳의 프라이빗 럭셔리 빌라를 손수 고른 작은 컬렉션. 요금은 각 숙소의 예약 페이지에서, 또는 비공개 문의를 보내 주세요.',
      primary: '컬렉션 보기', secondary: '비공개 문의',
    },
    villas: {
      eyebrow: '컬렉션',
      title: '빌라 7채. 여행지 4곳. 한 번의 비공개 문의.',
    ...
    about: {
      ...
      lede: '핀란드 라플란드에서 손수 고른 빌라와 스위트 일곱 채. 익명 문의, 각 숙소의 예약 페이지로 바로 연결, 그 사이에 어떤 플랫폼도 두지 않습니다.',
    },
  },
  home: {
    philosophy: {
      ...
      h2: '예약 플랫폼의 정반대.',
      items: [
        { title: '디렉터리가 아닌 짧은 목록.', body: '여정을 떠날 만한 이유가 분명한 여행지에 자리한 빌라와 스위트 일곱 채. 추가하기보다 거절하는 일이 더 많습니다, 이 페이지의 모든 항목은 안목 있는 여행자가 망설임 없이 예약할 수 있는 곳입니다.' },
        { title: '익명 문의.', body: '하나의 비공개 받은편지함뿐, 공개 프로필도 제3자와 공유하는 캘린더도 없습니다. 날짜, 인원, 선호 사항을 보내시면 영업일 기준 하루 안에 엄선된 추천 목록을 받아 보십니다.' },
        { title: '가능한 곳에서는 직접 요금.', body: '공개 매물은 요금이 표시된 각 숙소의 예약 페이지로 바로 연결됩니다. 공개된 요금이 없으면 숙소가 직접 견적을 냅니다. 저희는 가격을 정하지 않으며 예약도 받지 않습니다.' },
      ],
    },
    signature: {
      eyebrow: '시그니처 빌라',
  ...
  footerNote:
    '핀란드 라플란드에서 엄선한 프라이빗 컬렉션, 최종 검토 2026년 5월. 일부 예약은 제휴 수수료의 대상이 되지만, 어떤 빌라를 추천하는지에는 결코 영향을 주지 않습니다. 숙소가 돈을 내고 컬렉션에 들어올 수는 없습니다.',
  footerPillars: [
...
ko.hero.about = { eyebrow: '소개', title: '의도적으로 짧게 유지된 짧은 목록.', lede: '핀란드 라플란드에서 손수 고른 빌라와 스위트 일곱 채. 익명 문의, 각 숙소의 예약 페이지로 바로 연결, 중간 플랫폼 없음.' }
ko.home = {
  philosophy: {
    eyebrow: '운영 방식',
    h2: '예약 플랫폼의 정반대.',
