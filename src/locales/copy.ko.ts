...
const ko: SiteCopy = {
  ...
  hero: {
    home: {
      eyebrow: '빌라 {nFig}곳 · 목적지 {mFig}곳',
      title: '라플란드 빌라, 짐작 없이 고르세요.',
      lede: "유리 지붕 빌라와 디자인 스위트 {nFig}곳이 라플란드의 {mFig}개 지역에 있습니다. 각 숙소마다 전용 예약 페이지가 있고 Google 평점도 함께 보여 드립니다. 날짜를 보내 주시면 하루 안에 추려 낸 목록을 보내 드립니다.",
      primary: '빌라 보기',
      secondary: '추천 요청',
    },
    villas: {
      eyebrow: '빌라 목록',
      title: '빌라 {nFig}곳, 목적지 {mFig}곳. 메시지 하나면 됩니다.',
  ...
  home: {
    ...
    philosophy: {
      ...
      items: [
        { title: '검증된 숙소만.', body: '리스트에는 빌라와 스위트 {nFig}곳뿐입니다. 모두 숙소가 직접 공개한 정보와 최근 투숙객 후기로 확인하며, 리스트는 살아 있습니다. 수준이 유지되지 않으면 리스트에서 빠집니다.' },
