...
const ko: SiteCopy = {
  ...
  hero: {
    ...
    about: {
      ...
      lede: '핀란드 라플란드에서 손수 고른 빌라와 스위트 여덟 채. 익명 문의, 각 숙소의 예약 페이지로 바로 연결, 그 사이에 어떤 플랫폼도 두지 않습니다.',
    },
  },
  home: {
    philosophy: {
      ...
      h2: '예약 플랫폼의 정반대.',
      items: [
        { title: '디렉터리가 아닌 짧은 목록.', body: '여정을 떠날 만한 이유가 분명한 여행지에 자리한 빌라와 스위트 여덟 채. 추가하기보다 거절하는 일이 더 많습니다, 이 페이지의 모든 항목은 안목 있는 여행자가 망설임 없이 예약할 수 있는 곳입니다.' },
