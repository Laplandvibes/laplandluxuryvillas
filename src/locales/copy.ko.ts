...
const ko: SiteCopy = {
  ...
  villasPage: {
    ...
    leadP2: '이 사이트의 평점은 구글에서 왔고 객실 하나가 아니라 숙소 전체를 가리킵니다. 모든 카드에 그 사실을 적어 두었습니다. 컬렉션이 짧은 것은 의도한 것입니다. 다섯 목적지와, 유리 지붕부터 통나무 저택까지 다섯 가지 건축 유형을 다루고 거기서 멈춥니다. 수를 채우려고 늘리지 않습니다.',
...
Object.assign(ko.midnightSunPage, {
  ...
  planning: { h2: '백야 여행 계획에 대한 짧은 메모.', p1: '이 기간은 짧고 빌라는 개별 소유이므로, 캘린더는 균등하기보다 기회적으로 채워집니다. 일찍 문의하시는 편이 좋습니다.', p2: '특정 6월 문의의 적기는 그 해 1~3월입니다. 그 이후의 문의도 보낼 가치가 있습니다, 출시가 발생하니까요, 그러나 고급 인벤토리는 종종 더 일찍 나갑니다.', quoting: '현재 2026 + 2027 여름 견적 중' },
