...
const fi: SiteCopy = {
  ...
  cta: {
    browseCollection: 'Katso huvilat',
    beginPrivateInquiry: 'Aloita yksityinen tiedustelu',
    fullCollection: 'Kaikki huvilat',
    ...
    seeSummerCollection: 'Katso kesän huvilat',
    fullVillaCollection: 'Kaikki huvilat',
    sendPrivateInquiry: 'Lähetä yksityinen tiedustelu',
    sendAnother: 'Lähetä uusi tiedustelu',
    home: 'Etusivu',
    theCollection: 'Huvilat',
    sending: 'Lähetetään…',
    subscribe: 'Tilaa',
    subscribed: 'Tilattu',
  },
  badges: {
    ...
    alsoInCollection: 'Myös listalla',
    ...
    fullCollectionShort: 'Kaikki huvilat',
  },
  editorial: {
  ...
  hero: {
    ...
    villas: {
      eyebrow: 'Huvilat',
      title: '{n} huvilaa. {m} kohdetta. Yksi viesti riittää.',
  ...
  footerNote:
    'Käsin valittu huvilalista, koottu Suomen Lapissa, viimeksi katselmoitu toukokuussa 2026. Jotkin varaukset tuottavat kumppanuusprovision, joka ei koskaan vaikuta siihen mitä huviloita suosittelemme. Kohteet eivät voi maksaa päästäkseen listalle.',
  footerPillars: [
    { name: 'Huvilat', href: '/villas' },
