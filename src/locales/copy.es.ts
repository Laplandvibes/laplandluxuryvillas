...
const es: SiteCopy = {
  ...
  hero: {
    ...
    destinations: {
      eyebrow: 'Destinos',
      title: 'Saariselkä, Inari, Rovaniemi, Levi y Ylläs.',
    ...
    about: {
      ...
      title: 'Quién está detrás y qué no hacemos.',
  ...
  home: {
    ...
    philosophy: {
      ...
      items: [
        ...
        { title: 'Una propuesta en un día, sin compromiso.', body: 'Díganos sus fechas, el tamaño del grupo y lo que busca. Recibe una propuesta con las mejores opciones en un día, y sus datos de contacto no se comparten con ningún alojamiento hasta que usted mismo lo contacte.' },
  ...
  suitesPage: {
    intro: {
      p1Pre: '«Suite» en Laponia abarca dos gestos arquitectónicos distintos, vale la pena conocer ambos. El primero es la ',
  ...
  destinationPage: {
    ...
    inquiryBody: 'Envíe fechas, número de personas y cualquier preferencia (chef privado, uso exclusivo). Respondemos con una preselección en un día laborable.',
  },
  experiencesPage: {
    sections: {
  ...
  inquiryPage: {
    ...
    fields: {
      ...
      messageHint: 'Chef privado, uso exclusivo, accesibilidad, dieta, enfoque fotográfico, lo que sea que dé forma a la preselección.',
