...
const ja: SiteCopy = {
  ...
  hero: {
    home: {
      ...
      title: 'ラップランドの5つの目的地に、8棟のヴィラとスイート。',
      lede: 'ラップランド各地のプライベート・ラグジュアリーヴィラを厳選した小さなコレクション。料金は各宿の予約ページで、あるいはプライベートなお問い合わせを。',
      primary: 'コレクションを見る',
      secondary: 'プライベートお問い合わせ',
    },
    villas: {
      eyebrow: 'コレクション',
      title: '8棟のヴィラ、5つの目的地、1つのプライベートお問い合わせ。',
    ...
    about: {
      ...
      lede: 'フィンランド・ラップランドで厳選した8棟のヴィラとスイート。匿名でのお問い合わせ、各宿の予約ページへの直接リンク、間にプラットフォームを挟みません。',
    },
  },
  home: {
    philosophy: {
      ...
      items: [
        { title: 'ディレクトリではなく、厳選されたリスト。', body: '旅をする価値が確かにある目的地に絞った8棟のヴィラとスイート。新しい物件の追加よりも、お断りすることの方が多くなっています,このページに掲載されているのは、慎重な旅人が迷うことなく予約できる物件だけです。' },
        { title: '匿名でのお問い合わせ。', body: '一つのプライベート受信箱だけ。公開プロフィールも、第三者と共有するカレンダーもありません。日程、人数、ご希望をお送りください, 1営業日以内に厳選されたショートリストをお届けします。' },
        { title: '可能な限り直接料金で。', body: '公開リスティングは、料金が表示されている各宿の予約ページへ直接リンクしています。料金が公開されていない場合は、宿自身がお見積もりします。私たちが価格を決めることも、予約をお受けすることもありません。' },
      ],
    },
    signature: {
      eyebrow: 'シグネチャーヴィラ',
  ...
  footerNote:
    'フィンランド・ラップランドで厳選したプライベートコレクション,最終確認 2026年5月。一部のご予約はアフィリエイト手数料の対象となりますが、どのヴィラを推薦するかには一切影響しません。宿が対価を払ってこのコレクションに入ることはできません。',
  footerPillars: [
