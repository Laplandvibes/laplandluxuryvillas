...
const ja: SiteCopy = {
  ...
  midnightSunPage: {
    ...
    reasons: [
      ...
      { title: 'リザーブヴィラが開放されます。', body: '湖畔のプライベート・ログエステート、建築家の手によるシャレーがその年の残りのカレンダーを開放します。この期間は、専用シェフやヘリコプターチャーターがショルダー料金で対応する、1年で唯一の時期です。' },
    ...
    planning: {
      h2: '白夜の旅の計画にあたって。',
      p1: 'この期間は短く、各ヴィラは個別所有のため、カレンダーは均等にではなく機会次第で埋まっていきます。コンシェルジュは毎夏、リザーブエステートの少数枠を確保しています。',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '物件が掲載料を支払うことはありません。アフィリエイトリンクはTrip.comの公開リスティングを経由し、専用料金をもたらすものではありません。リザーブヴィラは何も支払いません,適切なお問い合わせに対する適切な答えだからこそ掲載しています。',
        ],
      },
      {
        title: '運営者',
      ...
      },
      {
        title: '直接取引',
        paragraphs: [
          'コレクション内のいくつかのヴィラは、現在直接お見積もりに対応しています。今後12ヶ月でこれを拡大する見込みです,物件と直接の関係を結び、仲介手数料なしの認証済み料金でゲストに予約していただけるようにします。それまでは、公開料金のヴィラはTrip.comにリンクし、コンシェルジュ限定のヴィラは直接お見積もりします。',
        ],
      },
      {
        title: '対応しない2種類のご旅行',
