...
const ja: SiteCopy = {
  ...
  hero: {
    home: {
      ...
      title: 'ラップランドの4つの目的地に、7棟のヴィラとスイート。',
    ...
    villas: {
      eyebrow: 'コレクション',
      title: '7棟のヴィラ、4つの目的地、1つのプライベートお問い合わせ。',
    ...
    about: {
      ...
      lede: 'フィンランド・ラップランドで厳選した7棟のヴィラとスイート。匿名でのお問い合わせ、各宿の予約ページへの直接リンク、間にプラットフォームを挟みません。',
    },
  },
  home: {
    philosophy: {
      ...
      items: [
        { title: 'ディレクトリではなく、厳選されたリスト。', body: '旅をする価値が確かにある目的地に絞った7棟のヴィラとスイート。新しい物件の追加よりも、お断りすることの方が多くなっています,このページに掲載されているのは、慎重な旅人が迷うことなく予約できる物件だけです。' },
