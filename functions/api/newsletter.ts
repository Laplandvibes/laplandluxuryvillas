...
// `send-welcome-email`. Lives at https://laplandluxuryvillas.com/api/newsletter.
//
// Why a proxy?  The Supabase function's CORS policy only allows
// https://laplandvibes.com. Spoke sites (laplandluxuryvillas.com etc.) would otherwise hit
